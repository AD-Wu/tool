...
//         if (needFormat(msg)) {
//             // 反射调用获取格式化之后的值
//             Object formatter = Clazzs.newObj(msg.format());
//             Method method = Methods.getMethod(msg.format(), msg.methodName());
...
//         return msg.format() != null && !Strings.isNull(msg.methodName());
//     }
//
